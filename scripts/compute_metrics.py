...
def run_test(cool1_path=None, cool2_path=None, output_metrics_path=None):
    if cool1_path and cool2_path and output_metrics_path:
        results = compare_cool_files(cool1_path, cool2_path)
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            results = compare_cool_files(tmp_cool1, tmp_cool2)
...
if __name__ == "__main__":
    ...
    run_test(args.cool1, args.cool2, args.output)
